...
class TraceDetailConsume extends StatefulWidget {
  final DetailId traceDetail;
  final ListTraceability trace;

  const TraceDetailConsume(
      {super.key, required this.traceDetail, required this.trace});

  @override
  State<TraceDetailConsume> createState() => _TraceDetailConsumeState();
}

class _TraceDetailConsumeState extends State<TraceDetailConsume> {
