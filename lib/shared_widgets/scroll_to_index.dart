...
mixin AutoScrollControllerMixin on ScrollController implements AutoScrollController {
  ...
  set parentController(ScrollController parentController) {
    ...
    if (isNotEmpty && _parentController != null) for (final p in positions) {
...
class AutoScrollTag extends StatefulWidget {
  ...
  const AutoScrollTag(
      {Key? key, required this.controller, required this.index, this.child, this.builder, this.color, this.highlightColor, this.disabled = false})
  ...
  Widget build(BuildContext context) {
    ...
    return widget.builder?.call(context, animation) ??
        buildHighlightTransition(
            context: context, highlight: animation, child: widget.child!, background: widget.color, highlightColor: widget.highlightColor);
  }
...
Widget buildHighlightTransition(
    {required BuildContext context, required Animation<double> highlight, required Widget child, Color? background, Color? highlightColor}) {
