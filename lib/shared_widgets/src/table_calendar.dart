...
import 'package:scc_web/shared_widgets/widgets/calendar_header.dart';
import 'package:scc_web/shared_widgets/widgets/cell_content.dart';
...
class VccCalendar<T> extends StatefulWidget {
  ...
  @override
  _VccCalendarState<T> createState() => _VccCalendarState<T>();
}

class _VccCalendarState<T> extends State<VccCalendar<T>> {
  ...
  @override
  void didUpdateWidget(VccCalendar<T> oldWidget) {
