...
class UpperSnackBar extends StatefulWidget {
  ...
  const UpperSnackBar.info({
    ...
    this.backgroundColor = const Color(0xff2F80ED), //const Color(0xff2196F3),
    this.boxShadow = kDefaultBoxShadow,
    this.borderRadius = kDefaultBorderRadius,
  }) : super(key: key);
  ...
  @override
  _UpperSnackBarState createState() => _UpperSnackBarState();
}

class _UpperSnackBarState extends State<UpperSnackBar> {
  @override
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Center(
        child: Padding(
          padding: const EdgeInsets.symmetric(vertical: 10), // widget.messagePadding,
...
const kDefaultBorderRadius = BorderRadius.all(Radius.circular(4));
